    ...
    <section className="relative ">
      ...
      <div className="container">
        <div className="text-center mb-14">
          ...
          <h2 className="mb-3 capitalize">How WIB LTD Works</h2>
          <p className="text-lightpurple max-w-2xl mx-auto md:text-lg font-normal md:leading-8 capitalize">
            At WIB LTD, we help businesses thrive. Simply contact us, discuss
            your requirements, and our expert team delivers reliable, innovative
